...
class StreamingHistogram(nn.Module):
    ...
    def plot(self, channel_names=None):
        ...
        plt.yscale('log')
        plt.title("Channel Histograms (Log Scale)")
...
if __name__ == "__main__": 
    ...
    # L1C stats
    stats = ClippedRunningStats((13,), dims=[0, 2, 3], shift_offset=0.0, saturation_threshold=10000.0)

    hist_computer = StreamingHistogram(num_channels=12, min_val=-1000, max_val=16000, bins=2000)
